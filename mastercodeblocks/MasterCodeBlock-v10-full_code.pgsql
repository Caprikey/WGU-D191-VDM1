			...
			BEGIN 
				...
				assign_row_number AS (
					...
					SELECT
						  a.customer_id
						, a.category_id
						, ROW_NUMBER() OVER (ORDER BY b.film_rank) as rental_rec_order_rn
						, a.film_id
			...
			BEGIN 
				...
				assign_row_number AS (
					...
					SELECT
						...
						, a.cat_rec_order
						, a.category_id
						, ROW_NUMBER() OVER (ORDER BY b.film_category_rank) as rental_rec_order_rn
						, a.film_id
               	...
               	, combined_customer_film_category_with_customer_category AS (
               		...
               		FROM 
               			combined_customer_list_to_film_category_details AS a 
               				...
               				LEFT JOIN
               					get_customer_category_historical_details AS b
               						ON a.customer_id = b.customer_id
...
--       17. vdm1_etl.f_vdm1_stage5_trigger_setup_ucrls_specific()
--       18. vdm1_etl.f_vdm1_stage5_trigger_setup_ucrlm_non_inf
--       19. vdm1_etl.f_vdm1_stage5_trigger_setup_ucrlm_spe_inf
--       20. vdm1_etl.f_vdm1_stage5_trigger_setup_uinvmaint_comp()
		...
		ELSE
			EXECUTE 
				'DROP TRIGGER IF EXISTS new_rental_update_category_popularity
				 ...
				 CREATE TRIGGER new_rental_update_category_popularity
					AFTER INSERT 
					ON vdm1_data.customer_watch_history_detailed
					FOR EACH ROW
					EXECUTE FUNCTION vdm1_data.t_f_update_category_popularity()';
		...
		ELSE
			EXECUTE 
				'DROP TRIGGER IF EXISTS update_inventory_maintenance_count
				 ...
				 CREATE TRIGGER update_inventory_maintenance_count
					AFTER INSERT 
					ON vdm1_data.customer_watch_history_detailed
					FOR EACH ROW
					EXECUTE FUNCTION vdm1_data.t_f_update_inventory_maintenance_count()';
		...
		ELSE
			EXECUTE
				'DROP TRIGGER IF EXISTS update_customer_reclist_master_nonspecific_new_rental
				 ...
				 CREATE TRIGGER update_customer_reclist_master_nonspecific_new_rental
					AFTER INSERT
					ON vdm1_data.customer_watch_history_detailed
					FOR EACH ROW
					EXECUTE FUNCTION vdm1_data.t_f_update_customer_reclist_master_nonspecific_new_rental()';
		...
		ELSE
			EXECUTE
				'DROP TRIGGER IF EXISTS update_customer_reclist_master_specific_new_rental
				 ...
				 CREATE TRIGGER update_customer_reclist_master_specific_new_rental
					AFTER INSERT
					ON vdm1_data.customer_watch_history_detailed
					FOR EACH ROW
					EXECUTE FUNCTION vdm1_data.t_f_update_customer_reclist_master_specific_new_rental()';
