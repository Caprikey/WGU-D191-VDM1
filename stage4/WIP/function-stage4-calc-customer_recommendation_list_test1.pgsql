CREATE OR REPLACE FUNCTION staging.f_vdm1_stage4_customer_recommendation_list_test1()
    RETURNS VOID
    LANGUAGE 'plpgsql'
    AS $$
    ...
    BEGIN
        ...
        CREATE TABLE staging.vdm1_stage4_customer_recommendation_list_test1 AS (
            ...
            ORDER BY 
                -- category_id
                customer_id, (category_rank_number, category_id, rec_order)
        )
