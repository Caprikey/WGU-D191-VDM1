CREATE OR REPLACE FUNCTION vdm1_etl.f_vdm1_stage5_table_enabled_logging_marketing()
    RETURNS VOID
    LANGUAGE plpgsql
    AS $vdm1_stage5_table_changes_activate_logging_marketing$
    ...
    END;
$vdm1_stage5_table_changes_activate_logging_marketing$;
